        ...
        @foreach ($accesos as $acceso)
            <li>
                ...
                >
                    ...
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="size-5 shrink-0 text-gris-pizarra">
                        <path d="m9 6 6 6-6 6" />
                    </svg>
                </a>
            </li>
